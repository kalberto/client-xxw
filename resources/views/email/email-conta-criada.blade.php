                                        ...
                                        <tr width="600" height="85">
                                            ...
                                            <td width="407" valign="middle">
                                                <table width="407" cellpadding="0" cellspacing="0" border="0">
                                                    <tr>
                                                        <td width="20"></td>
                                                        <td width="367" style="font-family: 'Trebuchet MS', Arial, sans-serif; font-size: 26px; color: #ffffff;">Conta criada</td>
                                                        <td width="20"></td>
                                                    </tr>
                                                </table>
                                            </td>
                        ...
                        <table width="600" height="500" align="center" valign="middle" cellpadding="0" cellspacing="0" border="0">
                            ...
                            <tr>
                                ...
                                <td width="470" style="font-family: 'Trebuchet MS', Arial, sans-serif; font-size: 16px; color: #000000;">
                                    <h1 style="margin-top: 10px; margin-bottom: 10px; font-family: 'Trebuchet MS', Arial, sans-serif; font-weight: bold; font-size: 16px; text-transform: uppercase; color: #000000;">Olá <strong style="color: #9bb381;"></strong></h1>
                                    <p style="font-family: 'Trebuchet MS', Arial, sans-serif; font-size: 16px; line-height: 1.4; color: #000000;">Sua conta foi criada com sucesso.</p>
                                    <br>
                                </td>
                                <td width="80"></td>
                            </tr>
