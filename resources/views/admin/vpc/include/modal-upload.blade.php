<a href="#" data-toggle="modal" data-target="#upload-modal" ref="modalUploadAnexoAdmin" hidden></a>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Selecione o arquivo para upload</p>
                <input type="file" accept="image/*,application/pdf" ref="file" name="file_name" class="form-control">
            ...
            <div class="modal-footer" v-if="!carregando_upload">
                <button type="button" class="btn btn-primary" @click="uploadArquivo()">Upload</button>
