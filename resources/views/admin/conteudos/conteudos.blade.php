    ...
    <div class="title-block">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">Conteudos</li>
            </ol>
        </nav>
    </div>
    @include('admin.include.search', ['route' => 'admin.conteudos.adicionar'])
...
@section('script')
    ...
    <script src="{{ url('js/admin/conteudos.js') }}"></script>
@endsection
