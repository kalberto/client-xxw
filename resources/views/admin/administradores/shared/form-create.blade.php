...
<div class="row">
    @include('admin.include.forms.input-text',['input_size' => 12, 'input' => '"email"','input_label' => 'Email:','place_holder' => 'Email', 'vue_var' => 'registro.email'])
</div>
<div class="row">
    @include('admin.include.forms.input-text',['input_size' => 6, 'input' => '"password"','input_label' => 'Senha:','place_holder' => 'Senha', 'vue_var' => 'registro.password','type'=>'password'])
    @include('admin.include.forms.input-text',['input_size' => 6, 'input' => '"re_password"','input_label' => 'Confirmar senha::','place_holder' => 'Confirmar senha:', 'vue_var' => 'registro.re_password','type'=>'password'])
</div>