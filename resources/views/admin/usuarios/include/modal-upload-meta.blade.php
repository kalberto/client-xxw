<a href="#" data-toggle="modal" data-target="#upload-modal-meta" ref="modalUploadPlanilhaMeta" hidden></a>
<div class="modal fade" id="upload-modal-meta">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Selecione o arquivo para upload das metas</p>
                <input type="file" accept=".xlsx,xls" ref="file_meta" name="file_name" class="form-control">
            ...
            <div class="modal-footer" v-if="!carregando_upload">
                <button type="button" class="btn btn-primary" @click="uploadArquivoMeta()">Upload</button>
