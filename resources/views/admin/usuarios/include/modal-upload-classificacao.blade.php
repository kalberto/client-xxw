<a href="#" data-toggle="modal" data-target="#upload-modal-classificacao" ref="modalUploadPlanilhaClassificacao" hidden></a>
<div class="modal fade" id="upload-modal-classificacao">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<p>Selecione o arquivo para upload das classificações</p>
				<input type="file" accept=".xlsx,xls" ref="file_classificacao" name="file_name" class="form-control">
			...
			<div class="modal-footer" v-if="!carregando_upload">
				<button type="button" class="btn btn-primary" @click="uploadArquivoClassificacao()">Upload</button>
