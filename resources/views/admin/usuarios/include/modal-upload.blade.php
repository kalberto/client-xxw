<a href="#" data-toggle="modal" data-target="#upload-modal" ref="modalUploadPlanilha" hidden></a>
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="file" accept=".xlsx,xls" ref="file" name="file_name" class="form-control">
